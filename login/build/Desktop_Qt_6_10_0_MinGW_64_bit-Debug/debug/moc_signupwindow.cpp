...
#include "../../../include/windows/signupwindow.h"
...
template <> constexpr inline auto SignupWindow::qt_create_metaobjectdata<qt_meta_tag_ZN12SignupWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'toggleConfirmPasswordVisibility'
...
void SignupWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->toggleConfirmPasswordVisibility(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SignupWindow::*)(const QString & , const QString & )>(_a, &SignupWindow::userRegistered, 0))
            return;
    }
}
...
// SIGNAL 0
void SignupWindow::userRegistered(const QString & _t1, const QString & _t2)
{
